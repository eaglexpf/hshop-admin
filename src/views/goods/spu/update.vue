<template>
  <div v-loading="loading" class="app-container">
        ...
        <div class="card-body">
          <el-row :gutter="layout.gutter">
            ...
            <el-col :xs="layout.xs" :sm="layout.sm" :md="layout.md" :lg="layout.lg">
              ...
              >
                <el-input
                  v-model.number="ruleForm.price_min"
    ...
    <div slot="footer" style="text-align: center;">
      ...
      <el-button type="primary" @click="updateGoodsSpu">保存</el-button>
    </div>
...
import { apiGoodsSpuInfo, apiGoodsSpuUpdate } from '@/api/goods/spu'
...
export default {
  ...
  methods: {
    ...
    getGoodsSpuInfo() {
      apiGoodsSpuInfo(this.$route.query).then((res) => {
        for (const item in this.ruleForm) {
          if (res.data[item]) {
            this.ruleForm[item] = res.data[item]
          }
        }
        if (res.data['params_value_data']) {
          this.choseGoodsParamsValueChange(res.data['params_value_data'])
        }
      })
    },
    ...
    updateGoodsSpu() {
      this.$refs['ruleForm'].validate((valid) => {
        ...
        this.loading = true
        apiGoodsSpuUpdate(this.$route.query, this.ruleForm).then((res) => {
          if (res['code'] === 0) {
